...
class FoodiePage extends StatefulWidget {
  final String title;
  const FoodiePage({super.key, required this.title});

  @override
  State<FoodiePage> createState() => _FoodiePageState();
}

class _FoodiePageState extends State<FoodiePage> {
